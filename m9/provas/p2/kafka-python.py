...
producer_config = {
    'bootstrap.servers': 'localhost:29092,localhost:29092',
...
topic = 'test_topic'
message = str(fake.pyfloat(min_value=1, max_value=1000, right_digits=2))
    ...
    while True:
        ...
        if msg.error():
            if msg.error().code() == KafkaError._PARTITION_EOF:
                ...
                print(msg.error())
                break
        print(f'CO_ppm: {msg.value().decode("utf-8")}')
